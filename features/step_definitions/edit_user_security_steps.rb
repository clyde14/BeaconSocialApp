#encoding: utf-8
When(/^I try to access a user's edit profile page directly$/) do
  visit "http://localhost:8000/users/21/edit"
...
When(/^I go to a user's profile page$/) do
  visit "http://localhost:8000/users/21"
  expect(page).to have_no_content 'Routing Error'
end
