...
And I enter  into the password_confirmation field
When I click the Create User button
Then I should see an error message saying Password can't be blank

Scenario: App rejects short password
Given I go to the signup page
And I enter Qw_12 into the password field
And I enter Qw_12 into the password_confirmation field
When I click the Create User button
Then I should see an error message saying Password is too short

Scenario: App rejects mismatching password
Given I go to the signup page
And I enter ABC_easy_as_123 into the password field
And I enter 123_ABC_easy into the password_confirmation field
When I click the Create User button
Then I should see an error message saying Password confirmation doesn't match Password
